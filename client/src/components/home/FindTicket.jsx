      ...
      <div className="w-[58.5rem] h-[14.75rem] bg-white rounded-r-md px-5">
        ...
        <div className="flex">
          <div className="">
            ...
            <input type="date" className="px-3 py-1 rounded-md border-[3px] border-slate-300 text-slate-400" />
          </div>
            ...
            <div className="">
              ...
              <div className="flex w-[25rem] justify-between mb-1">
                ...
                <div className="flex items-end">
                  <button className="px-4 py-2 bg-gradient-to-r from-[#EC7AB7] to-[#EC7A7A] hover:bg-gradient-to-r hover:from-[#e65ca6] hover:to-[#e05c5c] rounded-lg cursor-pointer text-white font-semibold">
                    Cari Tiket
                  </button>
                </div>
              </div>
